...
public class Picture extends SimplePicture 
{
  ...
  /** Method to negate blue/red/green **/
  public void Negate()
  {
    Pixel[][] pixels = this.getPixels2D();
    for(Pixel[] rowArray : pixels) {
  ...
  /** Method to turn the picture gray **/
  ...
  /** Method to make the fish visible in water.jpg **/
  ...
  public void copy2(Picture fromPic, int startRow, int startCol, int endRow, int endCol)
  {
    ...
    for(int row = startRow,int row2;
    row2 = startRow;
    startRow < endRow; row++, row2++)
    {
